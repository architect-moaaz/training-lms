...
import { LogOut, Shield, LayoutDashboard, GraduationCap } from 'lucide-react';
...
const Navbar: React.FC = () => {
  ...
  if (!user) {
    if (location.pathname === '/browse') {
      return (
        <nav className="bg-slate-900/80 backdrop-blur-xl border-b border-white/10 px-6 py-4 flex items-center justify-between">
          <div
